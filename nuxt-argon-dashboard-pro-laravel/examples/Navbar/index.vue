      ...
      <div id="navbar" class="mt-2 collapse navbar-collapse mt-sm-0 me-md-0 me-sm-4">
        ...
        <ul class="navbar-nav justify-content-end">
          <li class="nav-item dropdown d-flex align-items-center pe-2">
            <a id="dropdownMenuButton" href="#" :class="`p-0 nav-link text-white ${showProfile ? 'show' : ''}`"
              data-bs-toggle="dropdown" aria-expanded="false" @click="showProfile = !showProfile">
              <img :src="authStore.currentUser ? authStore.currentUser?.profile_image : defaultAvatar"
                class="avatar rounded-circle mx-2" />
              <span class="d-sm-inline d-none">{{ authStore.currentUser?.name }}</span>
            </a>
            <ul class="px-2 py-3 dropdown-menu dropdown-menu-end me-sm-n4" :class="showProfile ? 'show' : ''"
